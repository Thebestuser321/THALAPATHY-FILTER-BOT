...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002499223241').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002319965297')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002363140202')
...
DATABASE_NAME = environ.get('DATABASE_NAME', "tgbotsthalpathy")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'filter-files')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'All_in_1grp')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002249448496')).split()]
